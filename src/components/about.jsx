...
function About() {
  return (
    <div>
      <div className="flex justify-center items-center flex-col text-white pt-16 ">
        <div className="text-5xl font-bold text-white">About</div>
        <div className="pt-9 items-center text-center w-3/5 font-normal text-lg ">
          ...
          pursuing my B.Tech in Computer Science at Amrita Vishwa Vidyapeetham.
          As a full stack developer, I have a diverse skill set in both
          front-end and back-end web development. I excel in creating engaging
          user interfaces and implementing efficient server-side
          functionalities. With a strong understanding of software development
          principles, I am adept at using version control systems and following
          Agile methodologies. Continuously learning and staying updated with
